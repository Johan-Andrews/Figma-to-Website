...
import { aboutSection2 } from '../../data/content';
import workingImage from '../../assets/images/meeting2.png';
...
const AboutSection2 = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full xl:w-[1920px] xl:h-[600px] xl:absolute xl:top-[2337px] xl:left-0 bg-white py-16 md:py-24 lg:py-28 xl:p-0 xl:overflow-visible overflow-hidden"
    >
      {/* Desktop Artboard Layout (width >= 1280px) */}
      <div className="hidden xl:block relative w-[1920px] h-[600px] bg-white overflow-visible">

        {/* Polygon 2 — red/salmon triangle, upper-left of circle (behind circle) */}
        <div
        ...
        >
          <img src={workingImage} alt="Team working" className="w-full h-full object-cover" />
        </div>

        {/* Polygon 1 — red/salmon triangle, lower-right of circle (overlaps front of circle) */}
        <div
        ...
        {/* Text block — right side, Group 351 */}
        <div
          className="absolute z-10"
          style={{ left: '1030px', top: '126px', width: '720px' }}
        >
          {/* Heading */}
          <h2
          ...
          >
            <span 
              className="inline-flex items-center justify-center bg-[#D7EEDD] rounded-[100px] text-black mr-4 font-normal"
              style={{
                width: '172px',
                height: '80px',
            ...
            <span className="relative inline-block">
              ...
              <svg 
                ...
                className="relative left-[-30px] bottom-[11px] w-[105%] h-[22px] pointer-events-none text-[#FFC250]"
              >
                <path 
      ...
      <div className="xl:hidden">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left: Image (first in DOM on mobile, but let's place it left on desktop) */}
            ...
            <div className="lg:order-2">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-text-primary leading-tight mb-6" style={{ fontFamily: "'Syne', sans-serif" }}>
                <span className="px-4 py-1.5 bg-[#D7EEDD] rounded-full inline-block mr-2 font-normal">
                  See
                </span>{' '}
                how we can help you{' '}
